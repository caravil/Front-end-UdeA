...
.btn-primary {
    --bs-btn-color: #fff;
    --bs-btn-bg: #35944b;
    --bs-btn-border-color: #35944b;
    --bs-btn-hover-color: #fff;
    --bs-btn-hover-bg: #026937;
    --bs-btn-hover-border-color: #026937;
    --bs-btn-focus-shadow-rgb: 49, 132, 253;
    --bs-btn-active-color: #35944b;
    --bs-btn-active-bg: #35944b;
    --bs-btn-active-border-color: #026937;
    --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
    --bs-btn-disabled-color: #fff;
    --bs-btn-disabled-bg: #35944b;
    --bs-btn-disabled-border-color: #35944b
}

.btn-secondary {
    --bs-btn-color: #fff;
    --bs-btn-bg: #137598;  
    --bs-btn-border-color: #137598;
    --bs-btn-hover-color: #fff;
    --bs-btn-hover-bg:  #0e7774;
    --bs-btn-hover-border-color:  #0e7774;
    --bs-btn-focus-shadow-rgb: 130, 138, 145;
    --bs-btn-active-color: #137598;
    --bs-btn-active-bg: #137598;
    --bs-btn-active-border-color: # #0e7774;
    --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
    --bs-btn-disabled-color: #fff;
    --bs-btn-disabled-bg: #137598;
    --bs-btn-disabled-border-color: #137598
}
...
.bg-udea {
    --bs-bg-opacity: 1;
    background-color: rgba(var(--bs-udea-rgb), var(--bs-bg-opacity)) !important
}
